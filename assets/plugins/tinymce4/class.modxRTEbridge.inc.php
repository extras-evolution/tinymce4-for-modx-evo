...
/**
 * @author Deesen, yama / updated: 28.02.2016
...
if( !class_exists('modxRTEbridge')) {
    ...
    class modxRTEbridge
    {
        ...
        public function getEditorScript()
        {
            ...
            if (!isset($ph['pluginCustomParams'])) {
                $ph['pluginCustomParams'] = '';
            }; // Don´t leave [+pluginCustomParams+] in JS-initialization
        ...
        // SETTINGS PARTS
        // @todo:
        // - make options dynamic like setting schema to html4, html5, html5-strict, or just to html4 and html5
        //////////////////////////////////////////////////////////////////
