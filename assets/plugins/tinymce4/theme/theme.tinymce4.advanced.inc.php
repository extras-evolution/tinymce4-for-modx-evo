...
$this->set('plugins', 'anchor autolink lists spellchecker pagebreak layer table save hr link image imagetools code emoticons insertdatetime preview media searchreplace print contextmenu paste directionality fullscreen noneditable visualchars nonbreaking template youtube autosave advlist visualblocks charmap', 'string');
